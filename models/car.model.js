...
module.exports = (sequelize, DataTypes) => {
  const Car = sequelize.define('Car', {    
    ...
    model: { type: DataTypes.STRING, allowNull: false, unique: true ,validate: {notEmpty: true}},
    year: { type: DataTypes.STRING, allowNull: false, validate: {notEmpty: true}},
    registration_no: { type: DataTypes.STRING, allowNull: false, validate: {notEmpty: true}},
